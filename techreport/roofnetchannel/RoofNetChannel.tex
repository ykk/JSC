...
\begin{figure*}
\centering
\mbox{\subfigure[$1$ Mbps, Short Packet, PMF]{\includegraphics[width=0.45\linewidth]{BinDistro1}}
\subfigure[$1$ Mbps, Short Packet, CDF]{\includegraphics[width=0.45\linewidth]{BinDistroCDF1}}}
\mbox{\subfigure[$1$ Mbps, Long Packet, PMF]{\includegraphics[width=0.45\linewidth]{BinDistro2}}
\subfigure[$1$ Mbps, Long Packet, CDF]{\includegraphics[width=0.45\linewidth]{BinDistroCDF2}}}
\mbox{\subfigure[$2$ Mbps, Long Packet, PMF]{\includegraphics[width=0.45\linewidth]{BinDistro3}}
\subfigure[$2$ Mbps, Long Packet, CDF]{\includegraphics[width=0.45\linewidth]{BinDistroCDF3}}}
...
\begin{figure*}[ht]
\centering
\mbox{\subfigure[$5.5$ Mbps, Long Packet, PMF]{\includegraphics[width=0.45\linewidth]{BinDistro4}}
\subfigure[$5.5$ Mbps, Long Packet, CDF]{\includegraphics[width=0.45\linewidth]{BinDistroCDF4}}}
\mbox{\subfigure[$11$ Mbps, Long Packet, PMF]{\includegraphics[width=0.45\linewidth]{BinDistro5}}
\subfigure[$11$ Mbps, Long Packet, CDF]{\includegraphics[width=0.45\linewidth]{BinDistroCDF5}}}
