    ...
    implements EventTriggered
{
     ...
     * @param interarrival interarrival probability distribution
     * @param packetFactory factory for packets
     * @param flow network flow to add traffic to
     */
    public PacketSource(Distribution interarrival, PacketFactory packetFactory, 
			NetworkFlow flow)
    {
	this(interarrival,packetFactory, (MACNode) flow.source);
    }
     ...
     */
    public PacketSource(Distribution interarrival, PacketFactory packetFactory,
			NetworkFlow flow, int packetNumber)
    {
	this(interarrival,packetFactory, (MACNode) flow.source, packetNumber);
    }
