 ...
 * @author ykk
 */
public class DistanceChannelMap
    extends ChannelMap
{
    //Members
     ...
     */
    public MeanVarDistribution distro = new Gaussian(0,0);
     ...
     */
    public DistanceChannelMap(Network network, ChannelData chanData, MeanVarDistribution distro)
    {
	super(network);
     ...
     * @param chanData reference to channel data
     */
    public DistanceChannelMap(Network network, ChannelData chanData)
    {
	super(network);
	this.chanData = chanData;
    }
	...
	double distance;
	int networkSize = network.nodes.size();
	DistanceChannelMap newMap = new DistanceChannelMap(network, newChanData, distro);
